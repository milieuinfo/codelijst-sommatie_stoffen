...
excel_file <- "../resources/be/vlaanderen/omgeving/data/id/conceptscheme/sommatie_stoffen/sommatie_stoffen.xlsx"
target_csv_file <- "../resources/be/vlaanderen/omgeving/data/id/conceptscheme/sommatie_stoffen/sommatie_stoffen.csv"
riot_cmd <- paste("riot --formatted=TURTLE ../resources/be/vlaanderen/omgeving/data/id/conceptscheme/sommatie_stoffen/*.ttl > ", ttl_file, sep="")
system(riot_cmd)
