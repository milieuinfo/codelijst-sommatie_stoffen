...
df <- read.csv(file = "../resources/be/vlaanderen/omgeving/data/id/dataset/codelijst-sommatie_stoffen/catalog.csv", sep=",", na.strings=c("","NA"))
df <- df %>%
...
context <- jsonlite::read_json("../resources/be/vlaanderen/omgeving/data/id/dataset/codelijst-sommatie_stoffen/context.json")
df_in_list <- list('@graph' = df, '@context' = context)
df_in_json <- toJSON(df_in_list, auto_unbox=TRUE)
write(df_in_json, "/tmp/catalog.jsonld")
system("riot --formatted=TURTLE /tmp/catalog.jsonld > ../resources/be/vlaanderen/omgeving/data/id/dataset/codelijst-sommatie_stoffen/catalog.ttl")
system("riot --formatted=JSONLD ../resources/be/vlaanderen/omgeving/data/id/dataset/codelijst-sommatie_stoffen/catalog.ttl > ../resources/be/vlaanderen/omgeving/data/id/dataset/codelijst-sommatie_stoffen/catalog.jsonld")
